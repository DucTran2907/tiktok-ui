...
export const UploadIcon = function ({ width = '2.6rem', height = '2.6rem', className }) {
    return (
        <svg
...
export const MessageIcon = function ({ width = '2.6rem', height = '2.6rem', className }) {
    return (
        <svg
            className={cx(className)}
            width={width}
...
export const InboxIcon = function ({ width = '3.2rem', height = '3.2rem', className }) {
    return (
        <svg
            className={cx(className)}
            width={width}
...
export const SearchIcon = function ({ width = '2.4rem', height = '2.4rem', className }) {
    return (
